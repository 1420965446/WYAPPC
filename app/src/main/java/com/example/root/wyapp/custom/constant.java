...
public class constant {
    ...
    public static final String HOT_NEWS_URL = "http://c.m.163.com/nc/article/headline/T1348647909107/" +
    ...
    public static String getHotNewsUrl(int start, int end) {
        String hotNewsUrl = HOT_NEWS_URL.replace("START", start+"").replace("END", end+"");
        return hotNewsUrl;
    }
